...
maestor_team = Team(
    ...
    tools=[ReasoningTools(add_instructions=True)],
    instructions=[
        "Coordinate all member agents to analyze the RFP, extract structure, research technologies, draft full proposal sections, review language, harmonize tone, and score the proposal.",
        "Ensure the Section Writing Agent assembles a complete, section-by-section proposal draft using the outline, compliance matrix, and technology research before passing it to the English, Tone, and Scoring agents for review.",
        ...
        "Produce a final, consolidated proposal package with all required sections, compliance matrix, technology research, language review, tone harmonization, and scoring summary.",
